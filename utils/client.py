...
class ClientWrapper:
    ...
    def _submit_job(self, data, thumbnails: bool = False) -> str:
        """
    ...
    @catch_auth_exceptions
    def job_status(self, ticket_id: str, thumbnails: bool = False):
        """
    ...
    def download_embedding(self, embeddings_url: str):
        """
    ...
    def load_embedding(self, embeddings_path: str):
        """
    ...
    def load_thumbnail(self, local_path: str):
        """
